...
<body>
    ...
    <a href="../vistas/backup.php" style="text-decoration: none; color: inherit;">
    ...
    <a href="../vistas/mod_usuario.php" style="text-decoration: none; color: inherit;">
            <div>USUARIOS</div>
    </a>
    </div>
    ...
    <!-- LADO IZQUIERDO -->
    <div class="sidebar">
        <a href="../vistas/inicio_admin.php">INICIO</a>
